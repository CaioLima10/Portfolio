...
import imgProjectOne from "../../assets/Group 63.png"
  ...
  return (
    <TabsContent value={value} className="w-full flex flex-col lg:flex-row items-center justify-between">
      <Card>
        ...
        <a href="https://github.com/CaioLima10/criar_card_com_contador_id" target="_blank">
          <Button
        ...
        <a href="https://caiolima10.github.io/criar_card_com_contador_id/" target="_blank">
          <Button
            className={` px-3 lg:px-4 py-2 w-full lg:w-64 rounded-md bg-secondary relative text-white overflow-hidden group`}
            variant="outline"
          >
