import imgProjectOne from "../../assets/Group 20.png"
import { SiCss3, SiHtml5, SiJavascript, SiNodedotjs, SiSqlite } from "react-icons/si";
...
export default function FirstProject(props: IFirstProjectProps) {
      ...
      <Card>
        <CardContent className="w-full flex flex-col lg:flex-row space-y-2 lg:space-y-0 gap-6 mt-10">
          <div  className="w-full lg:w-1/2 space-y-1 lg:flex-grow">
            <h1 className="text-2xl lg:text-3xl mb-4 flex items-center justify-center">Study-phrases</h1>
            ...
            <div>
              ...
              <Card className="flex lg:flex-row items-center justify-center gap-4 lg:gap-10 text-3xl lg:text-5xl p-3 lg:p-5">
                <div className="flex flex-col items-center justify-center">
                  <SiNodedotjs />
                  <span className="text-sm lg:text-base">Nodejs</span>
                </div>
                <div className="flex flex-col items-center justify-center">
                  <SiJavascript />
                ...
                <div className="flex flex-col items-center justify-center">
                  <SiSqlite />
                  <span className="text-sm lg:text-base">SQLite3</span>
                </div>
              </Card>
            </div>
          </div>
        ...
        <CardFooter className="gap-2 w-full items-center justify-center md:flex md:items-start md:justify-start">
          <a href="https://github.com/CaioLima10/Study-Phrases" target="_blank">
            <Button
          ...
          <a href="https://www.linkedin.com/feed/update/urn:li:activity:7095120138093404160/" target="_blank">
            <Button
              className={` px-3 lg:px-4 py-2 w-full lg:w-64 rounded-md bg-secondary relative text-white overflow-hidden group`}
              variant="outline"
            >
