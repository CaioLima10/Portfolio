...
export default function AttributesSkills() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center relative mb-28" id="skills">
      <div className="w-full  min-h-full bg-slate-400/5">
      ...
      <div className="w-full h-96 bg-primary/5 flex ">
        <div className="w-1/2 p-2 bg-black relative">
          <TiArrowRepeat className="absolute top-5 left-44 text-3xl"/>

          {astronautOver ? (
            <img onClick={toggleAstronautImage} className="w-full z-20 " src={AstronautFocused} alt="" />
          ) : (
            <img onClick={toggleAstronautImage} className="w-full z-20 " src={AstronautFocus} alt="" />
          )}
        </div>
        <Separator className="h-full" orientation="vertical" />
        <div id="skills-responsive" className="w-3/4 p-4 grid gap-4 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          <Dialog>
              <DialogTrigger
                className="w-40 h-40 bg-slate-100/5 active:bg-background/40 shadow-lg shadow-slace-500/40 relative"
              >
                ...
                <div className="flex flex-col relative">
                  ...
                  <div className="p-8 w-full">
                    <span>
                      ...
                      do Guanabara no Visualg. Com o tempo, fui aprimorando meus conhecimentos e avancei para o JavaScript.
                      No início, foi desafiador compreender como trabalhar com eventos, classes e objetos, mas com determinação
                      e perseverança, comecei a entender esses conceitos. Hoje, sou capaz de criar aplicações utilizando o JavaScript
                      com confiança.
                    </span>
            ...
            <Dialog>
              <DialogTrigger className="w-40 h-40 bg-slate-100/5 active:bg-background/40 shadow-lg shadow-slace-500/40 relative">
                ...
                <div className="flex flex-col relative">
                  ...
                  <div className="p-8 w-full">
                    <span>
                      ...
                      fiquei imensamente feliz ao ver algo tão simples, mas impactante, aparecer na tela do navegador. Esse foi um dos
                      momentos pioneiros que fortaleceu minha paixão pelo desenvolvimento front-end.
                    </span>
            ...
            <Dialog>
              ...
              <DialogContent>
                <div className="flex flex-col relative">
                  ...
                  <div className="p-8 w-full">
                    <span>
                      CSS é uma ferramenta incrível para todos que sonham em se tornar front-end. Sabemos o quão impressionante
                      ela pode ser quando se trata de estilizar elementos. No meu caminho, enfrentei muitas dificuldades na parte de flexbox,
                      mas com muita perseverança, consegui aprender, e hoje, estilizar componentes se tornou uma das coisas mais gratificantes
                      de fazer. <br />
            ...
            <Dialog>
              ...
              <DialogContent>
                <div className="flex flex-col relative">
                  ...
                  <div className="p-8 w-full">
                    <span>
                      Estou começando a ganhar mais confiança na criação de aplicações em TypeScript, especialmente devido à segurança
                      proporcionada pelas tipagens. Sinto que com TypeScript, tenho a capacidade de desenvolver aplicações de maior porte
            ...
            <Dialog>
              ...
              <DialogContent>
                <div className="flex flex-col relative">
                  ...
                  <div className="p-8 w-full">
                    <span>
                      Gosto muito do desenvolvimento front-end, mas reconheço que um bom desenvolvedor precisa compreender como os dados são transmitidos.
                      Por isso, comecei a estudar Node.js para entender o funcionamento do backend e, ao mesmo tempo, criar projetos que integram
                      o front-end e o backend.
                    </span>
            ...
            <Dialog>
              ...
              <DialogContent>
                <div className="flex flex-col relative">
                  ...
                  <div className="p-8 w-full">
                    <span>
                      React foi a biblioteca com a qual mais me identifiquei, tanto pela forma de organizar pastas quanto pela maneira
                      de gerenciar rotas e pelas bibliotecas que você pode adicionar aos seus projetos para facilitar. Atualmente é a biblioteca
                      que mais gosto.
                    </span>
            ...
            <Dialog>
              ...
              <DialogContent>
                <div className="flex flex-col relative">
                  ...
                  <div className="p-8 w-full">
                    <span>
                      Estou me familiarizando com o Next.js, um framework que segue a mesma estrutura do React, e não estou tendo dificuldades.
                      Provavelmente, utilizarei esse framework em meus projetos futuros, pois a forma como ele lida com o deploy é muito simples
                      e eficaz para divulgar meus projetos.
                    </span>
            ...
            <Dialog>
              ...
              <DialogContent>
                <div className="flex flex-col relative">
                  ...
                  <div className="p-8 w-full">
                    <span>
                      Quando desenvolvo aplicações que envolvem o front-end e o back-end, aprecio bastante o uso do SQLite3 devido à simplicidade
                      na conexão com o banco de dados. Atualmente, tenho preferência por utilizar tanto o MySQL quanto o SQLite3.
                    </span>
